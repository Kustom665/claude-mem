#!/usr/bin/env python3
"""Inline the woff2 faces into the garden template.
...
TITLE = "枯山水 — The Dry Garden"
DESC = ("A digital dry-landscape garden: rake the gravel, draw a mantra, "
        "read your sign, and watch the stone count your sittings.")
